...
parser.add_argument('--action', nargs=1, required = True, choices=('start','stop','restart'),help = "Action to be taken on those services!")
parser.add_argument('--location',nargs=1, required = False,default = '/etc/init.d/', help="If specified, this is where the script will look for the services!")
